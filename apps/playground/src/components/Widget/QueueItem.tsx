...
export default function QueueItem({
  ...
  const { finalizeUnwrap, isSuccess } = useFinalizeUnwrap({
    ...
    >
      <div className="flex items-center justify-between gap-2">
        ...
        <button
          ...
          className="px-2.5 py-1.5 bg-primary hover:bg-primary/90 disabled:bg-muted text-primary-foreground rounded-dynamic text-[11px] font-medium transition-all disabled:cursor-not-allowed flex items-center justify-center gap-1 shrink-0"
        >
