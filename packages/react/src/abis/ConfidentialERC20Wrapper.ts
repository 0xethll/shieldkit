/**
 * ConfidentialERC20Wrapper ABI
 * Generic ERC7984 confidential token wrapper ABI
 * Can be used with any confidential token wrapper instance
 */

export const ConfidentialERC20WrapperABI = [
    {
      inputs: [
        {
          internalType: 'string',
...
export type ConfidentialERC20WrapperABI = typeof ConfidentialERC20WrapperABI
